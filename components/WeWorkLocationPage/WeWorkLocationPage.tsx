...
import { CITY, ILocationData } from '../../pages/reports/wework/interfaces';
import { EmblaCarousel } from '../EmblaCarousel/EmblaCarousel';
import { HeaderBio } from '../HeaderBio/HeaderBio';
import Map from '../MapBox/map';

export default function WeWorkLocationPage({locationData, city}:{locationData: ILocationData, city: CITY}) {
  return (
    <div className='prose mx-auto'>
      <HeaderBio presentation='min'/>
      <div className='flex flex-col gap-1'>
      <Header text={locationData.name}/>
      <Link href={`/reports/wework/${city.toLocaleLowerCase()}`}>{city} Guide</Link>
          <hr/>
