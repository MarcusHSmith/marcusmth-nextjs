...
export const data: ILocationData[] = [
  {
    ...
    weworkURL: new URL(
      "https://www.wework.com/buildings/warschauer-platz-11-13--berlin"
    ),
  ...
  },
  {
    ...
    weworkURL: new URL(
      "https://www.wework.com/buildings/friedrichstrasse-76--berlin"
    ),
  ...
  },
  {
    ...
    weworkURL: new URL(
      "https://www.wework.com/buildings/neue-schonhauser-strasse-3-5--berlin"
    ),
  ...
  },
  {
    ...
    weworkURL: new URL(
      "https://www.wework.com/buildings/kurfurstendamm-11--berlin"
    ),
    accolades: [ACCOLADE.BEST_VIEW],
    ...
    negatives: ["Without late night access, this was a one and done for me."],
  },
  {
    name: "Dircksenstraße 3",
    address: "Dircksenstraße 3 Berlin, BE 10179",
    weworkURL: new URL(
      "https://www.wework.com/buildings/dircksenstrasse-3--berlin"
    ),
    accolades: [ACCOLADE.BEST_OVERALL],
